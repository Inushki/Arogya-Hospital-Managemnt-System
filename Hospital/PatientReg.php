...
echo '<tr>
   <td>
     <form id="form1" name="form1" method="post" action="PatientSave.php">
     ...
     <tr>
        <td colspan="3" bgcolor="#000066"><span class="style1">PATIENT REGISTRATION</span></td>
     </tr>
     <tr>
        <td width="128" class="style3">Patient ID</td>
        <td width="180"><font color="#ffff00"><b>'.$patid.'</b></font></td>
        <td width="776" class="style3">&nbsp;</td>
     </tr>
     <tr>
        <td class="style3">Patient Name</td>
        <td colspan="2"><label>
