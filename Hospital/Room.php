...
<form id="form1" name="form1" method="post" action="">
 ...
 <td height="37" colspan="4" bgcolor="#000066"><blockquote>
   <p><span class="style1">ROOMS</span></p>
 </blockquote></td>
 </tr>
    <tr>
      <td colspan="3">&nbsp;</td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td width="192"><img src="Room-icon.png" width="113" height="92" /></td>
      <td width="751"><blockquote class="style3"><a href="RoomAva.php">Available Rooms</a></blockquote></td>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><img src="Admit.png" width="107" height="83" /></td>
      <td width="751"><blockquote class="style3"><a href="Admit.php">Admit</a></blockquote></td>
    </tr>
	<tr>
      <td>&nbsp;</td>
      <td><img src="Discharge.png" width="107" height="83" /></td>
      <td width="751"><blockquote class="style3"><a href="Discharge.php">Discharge</a></blockquote></td>
    </tr>
         <tr>
      <td colspan="3">&nbsp;</td>
    </tr>
