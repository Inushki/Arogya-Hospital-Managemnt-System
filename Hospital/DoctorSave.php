...
//die();
    ...
    //echo 
 $docid.'<br>'.$name.'<br>'.$nic.'<br>'.$cont.'<br>'.$email.'<br>'.$gen.'<br>'.$cs.'<br>'.$add;

      $conn=mysqli_connect('localhost','root','','hnd_027_proj');
      if($conn){
              $queSave="INSERT INTO 
 doctor(DocID,DName,NIC,ConNo,Email,Gender,CivilStat,DAdress) 
 VALUES('$docid','$name','$nic','$cont','$email','$gen','$cs','$add')";
...
<tr>
  ...
  <tr colspan="3">
                        <td align="center">
                        You have Successfully Save '.$docid.' to the Database!
                        </td>
</tr>
                     <tr>
                        <td align="center"><a href="DoctorID.php"><img src="back-icon.png" width="50" height="50"></a></td>
                     </tr>
                     <tr>
