...
$c=$_POST['rbCS'];
$a=$_POST['txaAdd'];
$queUp="UPDATE Patient SET 
PName='$n',NIC='$nic',ConNo='$cn',Email='$e',Gender='$g',CivilStat='$c',PAddress='$a' WHERE 
PatID='$eid'";
if(mysqli_query($conn,$queUp)){
header("Location:UpSuc.php");
}
}
$queGet="SELECT * FROM Patient2 WHERE PatID='$eid'";
...
<form id="form1" name="form1" method="post" action="">
 ...
 <tr>
 <td colspan="3" bgcolor="#000066"><span class="style1">EDIT PATIENT DETAILS</span></td>
 </tr>
 <tr>
 <td width="243" class="style10">Patient ID</td>
 <td width="173" class="style10"><font color="#000000"><?php echo $myRec['PatID'];?></font></td>
 <td width="611">&nbsp;</td>
 </tr>
 <tr>
 <td class="style10">Patient Name</td>
 <td colspan="2"><label>
 <input name="txtPName" type="text" class="style2" id="txtPName" size="60" maxlength="100" 
value="<?php echo $myRec['PName'];?>"/>
 </label></td>
 </tr>
 <tr>
