...
<?php
      echo '<tr>
              <td>
                 <form id="form1" name="form1" method="post" action="DocResult.php">
...
<tr>
            ...
            <tr>
               <td width="113" height="78" class="style3">Doctor ID</td>
           <td width="219">
                   <input name="txtDID" type="text" class="style2" id="txtDID" size="10" maxlength="10" /> 
            </td>
